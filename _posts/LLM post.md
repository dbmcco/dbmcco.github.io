---
id: 5e9f5e53-edfe-498d-a088-1933f67b3a95
---
# Developing intuition for CLI-based AI coding

![](/assets/images/gemini_generated_image_y3e6mdy3e6mdy3e6.png)
*This is what nano-banana thinks of my post*
...
![[Assets/llm-post/youre-absolutely-right-pepe.jpg]]

![[Assets/llm-post/old-man-yells-at-claude.jpg]]

And actual merch (courtesy of [Eran Sandler](https://www.linkedin.com/in/erans)):

![[Assets/llm-post/usage-limit-tshirt.jpg]]
...
![[Assets/llm-post/i-made-that-up.jpg]]
...
![[Assets/llm-post/wtf-kill-finder.png]]
...
I'm planning a follow-up post—a "[[LLM Post - Vault of Valuable Things|vault of valuable things]]"—that curates the actual repos, configs, and guidance on using them. This post is about the *why*; that one will be about the *what* and *how*.
...
![[Assets/llm-post/mobile-claude-skills.jpg]]
...
*See also: [[LLM Post - Vault of Valuable Things]] for a comprehensive list of repos, configs, and guidance.*
